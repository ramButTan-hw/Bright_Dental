...
function ReceptionistPage() {
  ...
  const loadCore = async () => {
    const [requestsData, timeOffData, locationData, departmentsData, scheduleData, notificationsData, insuranceChangeData, pharmacyChangeData, systemCancelledData] = await Promise.all([
